...
body = body_cascade.detectMultiScale(img, scaleFactor=1.5, minNeighbors=4)
...
# face_cascade = cv2.CascadeClassifier("haar_cascade_files/haarcascade_frontalface_alt.xml")
# # smile_cascade = cv2.CascadeClassifier("haar_cascade_files/haarcascade_smile1.xml")
# body_cascade = cv2.CascadeClassifier("haar_cascade_files/haarcascade_fullbody.xml")
...
#         # smile = smile_cascade.detectMultiScale(image, scaleFactor=2.5, minNeighbors=20)
